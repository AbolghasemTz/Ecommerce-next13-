...
function ContentInfo({ product }) {
  return (
    <div className="col-span-12 md:col-span-8 lg:col-span-10 xl:col-span-10">
      <div className="flex flex-col lg:flex-row md:bg-white rounded-lg md:p-4">
                ...
                <li className="flex  gap-y-2 flex-row lg:gap-x-2">
                  ...
                  {product?.tags?.map((t, i) => {
                    return (
                      <span
                        key={i}
                        className="border border-gray-150 rounded-md cursor-pointer flex justify-center items-center w-12 h-10"
                      >
                        {t}
                      </span>
                    );
        ...
        <div className="lg:w-1/3 xl:w-1/4 hidden md:block">
